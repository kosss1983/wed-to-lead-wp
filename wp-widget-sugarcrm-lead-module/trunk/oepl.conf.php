...
function PluginStyleJS() {
	...
	if($_GET['page'] == 'mapping_table')
	{
		wp_enqueue_style("OEPL-Switchbox-css", OEPL_PLUGIN_URL ."style/jquery.switchButton.css", false, "1.0", "all");
		wp_enqueue_script('OEPL-jquery-ui',OEPL_PLUGIN_URL.'/js/jquery-ui.min.js');
		wp_enqueue_script('OEPL-jquery-switchbox',OEPL_PLUGIN_URL.'/js/jquery.switchButton.js');
		wp_enqueue_script('OEPL-field-list',OEPL_PLUGIN_URL.'/js/field-list.js');
	}
}
