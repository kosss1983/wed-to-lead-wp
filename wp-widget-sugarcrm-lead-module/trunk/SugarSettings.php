...
if ($EmailNotification == 'Y')
	...
	$Email_checked = '';
if ($IPaddrStatus == 'Y')
	$IP_checked = 'checked="checked"';
else
	$IP_checked = '';
if ($redirectStatus == 'Y')
	$redirectCbx = 'checked="checked"';
else
	$redirectCbx = '';
if ($htaccessProtected == 'Y')
	$htacessCbx = 'checked="checked"';
else
	$htacessCbx = '';
			...
			<table align="left" cellpadding="1" width="100%" cellspacing="1" border="0" >
				<tr height="30">
					...
					<div style="float: left">
						<h2 style="color: #795548;font-weight: 900">WordPress to Sugar / SuiteCRM Lead</h2>
					</div>
					<div style="float: right">
						<a href="<?php echo admin_url('admin.php?page=SugarSetting&view=pro'); ?>" class="OEPL_get_pro">Get Pro version</a>
					</div></td>
				</tr>
				<tr>
					<td valign="top" style="">
					<div class="OEPL_tab_settings">
						<ul class="tabs">
							<li class="<?php echo($_GET['view'] == 'sugarSettings' ? 'active' : ''); ?>">
								<a href="<?php echo admin_url('admin.php?page=SugarSetting&view=sugarSettings'); ?>">Sugar / SuiteCRM Settings</a>
							</li>
							<li class="<?php echo($_GET['view'] == 'generalSettings' ? 'active' : ''); ?>">
								<a href="<?php echo admin_url('admin.php?page=SugarSetting&view=generalSettings'); ?>">General Settings</a>
							</li>
							<li class="<?php echo($_GET['view'] == 'messageSettings' ? 'active' : ''); ?>">
								<a href="<?php echo admin_url('admin.php?page=SugarSetting&view=messageSettings'); ?>">Message Settings</a>
							</li>
							<li class="<?php echo($_GET['view'] == 'CustomCSS' ? 'active' : ''); ?>">
								<a href="<?php echo admin_url('admin.php?page=SugarSetting&view=CustomCSS'); ?>">Custom CSS</a>
							</li>
							<li class="<?php echo($_GET['view'] == 'ShortCode' ? 'active' : ''); ?>">
								<a href="<?php echo admin_url('admin.php?page=SugarSetting&view=ShortCode'); ?>">Short Code</a>
							</li>
							<li class="<?php echo($_GET['view'] == 'pro' ? 'active' : ''); ?>">
								<a href="<?php echo admin_url('admin.php?page=SugarSetting&view=pro'); ?>">Pro Features</a>
							</li>
							<li class="<?php echo($_GET['view'] == 'CRMPlugins' ? 'active' : ''); ?>">
								<a href="<?php echo admin_url('admin.php?page=SugarSetting&view=CRMPlugins'); ?>">Sugar Plugins</a>
							</li>
							<li class="<?php echo($_GET['view'] == 'SuitePlugins' ? 'active' : ''); ?>">
								<a href="<?php echo admin_url('admin.php?page=SugarSetting&view=SuitePlugins'); ?>">SuiteCRM Plugins</a>
							</li>
...
**************************************/
									?>
									<div class="title">
										<span class="fa fa-gears fa-1x" ></span> Sugar / SuiteCRM REST API Settings
									</div>
									<tr>
									<td><strong>Sugar / SuiteCRM URL :</strong><br />
									<input name="OEPL_SUGARCRM_URL" type="text" id="OEPL_SUGARCRM_URL" value="<?php echo get_option('OEPL_SUGARCRM_URL'); ?>" size="53" required/>
									<p class="description">Your Sugar / SuiteCRM REST API URL will be <Domain>/service/v4_1/rest.php.<br />i.e. http://mycrm.com/service/v4_1/rest.php <b>or</b> http://demo.mycrm.com/service/v4_1/rest.php</p></td>
									</tr>
									<tr>
...
$captchaSettings = get_option('OEPL_Captcha_status');
									?>
									<div class="title">
										<span class="fa fa-tachometer fa-1x" style="font-size: 25px"></span> Plugin Genaral Settings
									</div>
									<tr>
										...
										<p class="description">
											You can Enable or Disable CAPTCHA on your Lead-Forms anytime you want.
										</p></td>
									</tr>
									<tr>
									...
									<tr class="EmailToTR" style="display: none">
										...
										<p class="description">
											Provide Email address to which notification will be sent. Multiple recipients may be specified using a comma ( , ) separated string.
										</p></td>
									</tr>
									<tr>
									...
									<tr class="OEPL_redirect_tr" style="display: none">
										...
										<p class="description">
											Please enter URL including http://...
											<br />
											<strong>example :</strong> http://www.DomainName.com/
										</p></td>
									</tr>
									<tr height="8"></tr>
									<tr>
									...
									**************************************/
									?>
									<div class="title">
										<span class="fa fa-comments fa-1x" style="font-size: 25px"></span> Plugin Message Settings
									</div>
									<tr>
									...
									**************************************/
									...
									<div class="title">
										<span class="fa fa-pencil-square-o fa-1x" style="font-size: 25px"></span> Custom CSS
									</div>
									<tr>
									...
									**************************************/
									?>
									<div class="title">
										<span class="fa fa-bolt fa-1x" style="font-size: 25px"></span> Wordpress to Sugar and SuiteCRM form builder PRO
									</div>
									<p>
										Thank you for using our Plugin. It's always nice to have more on your plate. Our PRO edition will help you to <strong>generate unlimited web-forms</strong> in few simple steps via user friendly drag & drop designed based form-builder.
									</p>
									...
									**************************************/
									?>
									<div class="title">
										<span class="fa fa-bolt fa-1x" style="font-size: 25px"></span> Shor Code
									</div>
									<h3>[OEPL_CRM_Lead_Form]</h3>					
									<?php } ?>

									<?php if($_GET['view'] == 'CRMPlugins') { ?>
									<div class="title">
										<span class="fa fa-bolt fa-1x" style="font-size: 25px"></span> Our Sugar Plugins
									</div>

									<span class="fa-1x" style="font-size: 25px"><a href="https://goo.gl/kkQrIx" target="_blank">Scan Identical Leads</a> <span class="blink3oDays">Free 30 day trial</span></span>
									...
									<br />
									<br />
									<span class="fa-1x" style="font-size: 25px"><a href="https://goo.gl/RkLUnN" target="_blank">Proximity Search</a> <span class="blink3oDays">Free 30 day trial</span></span>
									<div class="PluginDesc">
									...
									<div class="title">
										<span class="fa fa-bolt fa-1x" style="font-size: 25px"></span> Our SuiteCRM Plugins
									</div>

									<span class="fa-1x" style="font-size: 25px"><a href="https://goo.gl/pY2V7O" target="_blank">Scan Identical Leads</a> <span class="blink3oDays">Free 30 day trial</span></span>
									<div class="PluginDesc">
										Have newly created leads? Processing imported leads from one or more sources? Quickly identify if there is already an existing lead by setting up your predefined parameters. Any possible duplicates will be highlighted and noted when viewing a given lead.
									</div>
									<br /><br />
									<span class="fa-1x" style="font-size: 25px"><a href="https://goo.gl/E9J1JL" target="_blank">Proximity Search</a> <span class="blink3oDays">Free 30 day trial</span></span>
									<div class="PluginDesc">
										Proximity searches are becoming more essential to businesses every day. Sales and marketing teams use them to organize field visits and campaigns. The real estate industry use them to offer better alternative locations to their customers. Hotel, travel and tourism businesses use them to offer various accommodation options and places to visit. How will you use it?
									</div>
			...
			<table class="OEPL_promotion" >
				<tr>
					<td ><a href="http://goo.gl/OPbP50" target="_blank"><img class="Social_icons" src="<?php echo OEPL_PLUGIN_URL.'image/Offshore-Evolution.jpg'?>" alt="Offshore Evolution - We make your IT needs live" title="Offshore Evolution - We make your IT needs live" style="height: 110px" /></a>
					<br />
					</td>
				</tr>
				<tr>
					<td >
					<div style="font-size: 14px;margin-top: 8px;font-weight: 600;margin-right: 0px">
						&nbsp;Website : <a href="http://goo.gl/OPbP50" target="_blank">www.offshoreevolution.com</a>
					</div></td>
				</tr>
				<tr>
					<td colspan="3">
					<div style="font-size: 14px;margin-top: 0px;font-weight: 600">
						Support: <a href="mailto:support@offshoreevolution.com?subject=WP plugin - <?php echo get_bloginfo('name'); ?>&body=Hi Dipesh, %0D%0A %0D%0A Website: <?php echo get_bloginfo('url'); ?> %0D%0A %0D%0A Questions: %0D%0A %0D%0A Suggestions:">support@offshoreevolution.com</a>
					</div></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="OEPL_promotion_tab" >
					<div align="center" style="font-size: 14px;font-weight: 600">
						We'd love to hear from you
					</div>
					<br />
					Would you mind taking a few minutes to write a review for us please ? It will be very helpful to us & will keep us motivated.
					<br />
					<br />
